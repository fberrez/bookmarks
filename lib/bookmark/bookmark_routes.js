...
export default function router(fastify, opts, done) {
   ...
   *  }
   *
   * @apiError (400) LimitNotValid Limit not valid
   * @apiError (400) PageNotValid Page not valid
   * @apiError (404) BookmarkNotFound Bookmark not found
	 */
	fastify.get('/', get);
   ...
   * }
   *
   * @apiError (400) IdNotValid Id not valid
   * @apiError (404) BookmarkNotFound Bookmark not found
	 */
   ...
   * }
   *
   * @apiError (400) MissingURL Missing required field: url
   * @apiError (400) MissingType Missing required field: type
   * @apiError (400) UrlNotValid Url not valid
	 */
	fastify.post('/', create);
	 ...
	 * @apiParam (Body Params) {string[]} keywords list of keywords, separated by comas.
	 * @apiExample {curl} Example usage:
   *  curl -XPUT -H 'Content-type: application/json' --data '{"keywords":"new,keywords"}' localhost:3000/bookmarks/61ccaf911c1db63ccd104b6f
   *
	 * @apiSuccess (200) {string} id bookmark object id.
   * @apiSuccess (200) {string} url bookmark url.
   * @apiSuccess (200) {string} type bookmark type.
   ...
   *
   * @apiError (400) IdNotValid Id not valid
   * @apiError (400) MissingKeywords Missing required field: keywords
   * @apiError (404) KeywordNotFound Keyword not found
	 */
